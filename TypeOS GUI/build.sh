...
/usr/local/i386elfgcc/bin/i386-elf-ld -o "kernel.bin" -Ttext 0x1000 "kernel_start.o" "kernel.o" --oformat binary
...
rm boot.bin
rm zeroes.bin
qemu-system-i386 -drive file=OS.dsk,index=0,if=floppy